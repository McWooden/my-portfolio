        ...
        <div className="flex flex-col gap-8 text-left justify-between">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              {isAdmin && (
                <div className="py-2 border-t border-b border-neutral-900/60 my-2">
                  <button
                    type="button"
                    onClick={() => setFeatured(!featured)}
                    className="flex items-center gap-3 cursor-pointer group focus:outline-none"
                  >
                    <div className={`w-5 h-5 rounded-md border flex items-center justify-center transition-all duration-200 ${featured ? 'bg-accent border-accent text-neutral-950' : 'border-neutral-700 bg-transparent text-transparent group-hover:border-neutral-500'}`}>
                      <svg className="w-3.5 h-3.5 stroke-[3] stroke-current" fill="none" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                    <span className="text-xs font-mono uppercase tracking-wide text-neutral-400 select-none group-hover:text-white transition-colors duration-150">
                      Feature on Home
                    </span>
                  </button>
                </div>
