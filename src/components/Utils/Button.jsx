...
export default function Button({
  ...
  const baseStyle = "font-sans transition-all duration-200 hover:-translate-y-0.5 select-none text-center flex items-center justify-center whitespace-nowrap";
  ...
  const variants = {
    ...
    'email-pill': "flex items-center gap-3 bg-bg-dark border border-text-muted px-4 py-2 rounded-full text-[0.95rem] font-medium text-text-primary hover:border-text-primary hover:bg-bg-card hover:-translate-y-px max-md:px-3 max-md:py-1.5 max-md:text-[0.85rem]",
  };
