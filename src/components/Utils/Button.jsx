...
export default function Button({
  ...
  const variants = {
    ...
    'email-pill': "flex items-center gap-3 bg-bg-dark border border-accent px-4 py-2 rounded-full text-[0.95rem] font-medium text-text-primary hover:border-text-primary hover:bg-bg-card hover:-translate-y-px max-md:px-3 max-md:py-1.5 max-md:text-[0.85rem]",
  };
