 ...
 */
export default function StatusTooltip({ partitions, className = '' }) {
  ...
  return (
    <div className={`absolute bg-neutral-900 border border-neutral-800/80 px-3 py-2.5 rounded-xl text-[10px] font-mono text-neutral-400 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-all duration-200 shadow-2xl whitespace-nowrap z-50 text-left flex flex-col gap-1 ${className}`}>
