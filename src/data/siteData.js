...
export const blogPosts = [
  {
    slug: "things-i-wish-clients-knew",
    category: "Client Tips",
    date: "May 26, 2025",
    title: "Things I Wish Clients Knew",
    subtitle: "Good design needs clear communication. Here’s what helps",
    coverImage: "https://framerusercontent.com/images/QVNe6TRafmgQ9RrDW8Plro5o7Q.png",
    paragraphs: [
  ...
  {
    slug: "ideas-in-progress",
    category: "Exploration",
    date: "May 23, 2025",
    title: "Ideas in Progress",
    subtitle: "Why I share unfinished things — and what I learn from them",
    coverImage: "https://framerusercontent.com/images/39cbxNcoHdMYljiFrC1HqeYcSL4.png",
    paragraphs: [
  ...
  },
  {
    ...
    subtitle: "Thoughts on creative rhythm, messy drafts, and that quiet moment when it finally clicks",
    coverImage: "https://framerusercontent.com/images/nHLoJzaknyK5lbWuOrCqRlOhvGA.png",
    paragraphs: [
  ...
  },
  {
    ...
    date: "May 19, 2025",
    title: "Design Notes",
    subtitle: "Why spacing is more emotional than you think",
    coverImage: "https://framerusercontent.com/images/iU0Y8Ode8XTT75k7isG5NvqmQ8U.png",
    paragraphs: [
      ...
      "Note 1: Padding creates tone\n\nNot everything has to be perfectly symmetrical. In fact, small shifts — like slightly tighter spacing between a title and subtitle, or more margin under a paragraph than above — can make your design feel less robotic.",
      "Note 2: Uneven beats feel human\n\nBalanced ≠ equal. Sometimes the numbers lie. You can have two perfectly measured objects that look misaligned. Train your eye — and trust it more than your layout grid when it comes to visual weight. It’s not cheating. It’s good design.",
...
export const reviews = [
  {
    rating: "5.0",
    text: "Every detail felt intentional. The visuals Nico created became the foundation of our new identity",
    author: "Riley James",
    company: "Nova"
  },
  {
    rating: "4.8",
    text: "We’ve worked with several designers, but this was the first time we felt truly understood",
    author: "Marta L.",
    company: "Alder & Co"
  },
  {
    rating: "5.0",
    text: "Clean, fast, and on-brand from the very first draft. We didn’t change a thing",
    author: "Tomas E.",
    company: "Onyx Skincare"
  },
  {
    rating: "5.0",
    text: "Sharp taste, fast execution, zero ego. We loved working together",
    author: "Sofia R.",
    company: "Studio Terra"
  },
  {
    rating: "5.0",
    text: "It finally looks like us. That’s what good design should do",
    author: "Daniel M.",
    company: "Kairo"
  }
];
...
export const certifications = [
  {
    ...
    name: 'freeCodeCamp',
    label: 'fC',
    description: 'Completed interactive curriculums covering responsive design, front-end libraries, and back-end APIs.'
  },
  {
    id: 'SL',
    name: 'Sololearn',
    label: 'SL',
    description: 'Earned certificates for core programming concepts, data structures, and algorithms across multiple technologies.'
  },
  {
    id: 'CP',
    name: 'Codepolitan',
    label: 'CP',
    description: 'Completed professional developer bootcamps covering modern frameworks, database management, and tooling.'
  }
];
...
export const communities = [
  {
    id: 'TK',
    name: 'Titik Koma',
    url: 'https://www.youtube.com/@webprogrammingunpas',
    label: ';',
    description: 'An active programming learning space led by Sandhika Galih (Web Programming UNPAS). Highly focused on web development fundamentals, modern ecosystems, and mentoring Indonesian developers.'
  },
  {
    id: 'CU',
    name: 'Cuy Universe',
    url: 'https://deaafrizal.com',
    label: 'CU',
    description: 'A software engineering and technology discussion community founded by Dea Afrizal. Focused on engineering challenges, career pathways, dev roundtables, and project showcases.'
  }
];
